...
<div>
    ...
    <img style="width:40px;" src="./logos/php.png" alt="php logo"/>
    <img style="width:40px;" src="./logos/mysql.png" alt="mysql logo"/>
    <img style="width:40px;" src="./logos/npm.png" alt="npm logo"/>
    <img style="width:40px;" src="./logos/reactjs.png" alt="reactjs logo"/>
    <img style="width:40px;" src="./logos/nextjs.png" alt="nextjs logo"/>
    <img style="width:40px;" src="./logos/git.png" alt="git logo"/>
    <img style="width:40px;" src="./logos/github.png" alt="github logo"/>
